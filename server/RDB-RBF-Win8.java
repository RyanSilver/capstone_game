...
public class RDB
{
  ...
  public static int[] correctCoord(int [] p, String d)
  {
    ...
    {
      newx += tRisk.circleSize;
      newy += tRisk.circleSize*0.5;
    }
    else if (d.equals("se"))
    {
      newx += tRisk.circleSize*0.75+2;
      newy += tRisk.circleSize*0.75+2;
    }
    else if (d.equals("s"))
    {
      newx += tRisk.circleSize*0.5;
      newy += tRisk.circleSize;
    }
    else if (d.equals("sw"))
    {
      newx += tRisk.circleSize*0.25+2;
      newy += tRisk.circleSize*0.75+2;
    }
    else if (d.equals("w"))
    {
    ...
    {
      newx += tRisk.circleSize*0.25-4;
      newy += tRisk.circleSize*0.25-4;
    }
    ans[0] = newx;
    ans[1] = newy;
    return ans;
