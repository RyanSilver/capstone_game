...
public class playerA {
    ...
    /**
     * gives cubbyholes to playernode 
     * @param a
     * @param b
     */
    public playerA(CubbyHole a, CubbyHole b) {
        super();
        rec = a;
        send = b;
        //start();
...
//
    ...
    //added by ryan silver for testing
     ...
     * @return
     */
    public String switchStmt(String sss) {
