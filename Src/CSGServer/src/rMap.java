    ...
    public void paint(Graphics g) {
        for (int i = 0; i < items.size(); i++) {
            ...
            if (tok[1].equals("CIRCLE")) {
                ...
                if (tok[4].equals("BLUE")) {
                    c = Color.blue;
                }
                if (tok[4].equals("WHITE")) {
                    c = Color.white;
                }
                if (tok[4].equals("YELLOW")) {
                    c = Color.yellow;
                }
                if (tok[4].equals("GREEN")) {
                    c = Color.green;
                }
                if (tok[4].equals("GRAY")) {
                    c = Color.gray;
                }
                if (tok[4].equals("CYAN")) {
                    c = Color.cyan;
                }
                if (tok[4].equals("DARKGRAY")) {
                    c = Color.darkGray;
                }
                g.setColor(c);
...
/**
 * sets up a java swing map for the server. no longer used in current version
 * @author Ryan
 */
